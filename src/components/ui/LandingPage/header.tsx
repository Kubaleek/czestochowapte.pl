                ...
                <div>
                    <div className="grid grid-cols-2 gap-4 items-center">
                                ...
                                <div className="flex items-start leading-9">
                                    ...
                                    <div>
                                        <div className="pl-[8px] flex flex-col justify-center">
                                            <p className="text-[#17822e] font-semibold  LogoFontText  text-[30px]">
                                                Polskie
                                            </p>
                                            <p className="text-[#17822e] LogoFontText font-semibold text-[30px]">
                                                Towarzystwo
                                            </p>
                                            <p className="text-[#17822e] LogoFontText font-semibold  text-[30px]">
                                                Ekonomiczne
                                        ...
                                        <div className="flex flex-col pl-[8px] justify-center  min-w-[240px]">
                                            <p className="text-[#17822e]  LogoFontText font-semibold text-[20px]">
                        ...
                        <div className="ml-24 flex mx-auto">
                            <span>
                                <Image
                                    src={'/stare_zdjecie_czestochowy.jpg'}
                                    width={564}
                                    height={200}
                                    className="max-w-[400px]"
                                    alt="stare_zdjecie_czestochowy "
                                />
                            </span>
                        </div>
                    </div>
