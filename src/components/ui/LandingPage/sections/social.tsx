...
export default function SocialSection() {
  return (
    <section className="col-span-12 md:col-span-5 lg:col-span-5 xl:col-span-4 flex flex-col gap-3">
      <h2 className="hidden md:flex items-center">
        ...
        <span className="text-2xl sm:text-[28px] text-black font-bold m-0">Social media</span>
      </h2>
        ...
        <div className="flex gap-[24px]">
          <a href="https://x.com/PTE_ZK" className="hover:text-black transition-all w-8 h-8">
            <svg
              ...
              data-prefix="fab"
              data-icon="twitter"
              className="svg-inline--fa fa-twitter w-8 h-8"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
          ...
          <a href="https://www.facebook.com/profile.php?id=100064391691386" className="hover:text-black transition-all w-8 h-8">
            <svg
              ...
              data-prefix="fab"
              data-icon="facebook"
              className="svg-inline--fa fa-facebook w-8 h-8"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
