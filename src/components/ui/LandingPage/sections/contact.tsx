...
import Maps from "../icon/map";
import { Separator } from "@/components/shadcn/separator";
import cityContacts from "@/lib/cityContact";
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-row items-center gap-3">
            <svg
              ...
              data-prefix="fas"
              data-icon="envelope"
              className="svg-inline--fa fa-envelope fa-fw w-4 h-4"
              role="img"
          ...
          <div className="flex flex-row items-center gap-3">
            <svg
              ...
              data-prefix="fas"
              data-icon="phone"
              className="svg-inline--fa fa-phone fa-fw w-4 h-4"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
            >
          ...
          <div className="flex flex-row items-center gap-3">
            <svg
              ...
              className="svg-inline--fa fa-location-dot fa-fw w-4 h-4"
              role="img"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
            >
            ...
            <div className="flex flex-wrap justify-center gap-3 lg:w-3/4">
              {Object.keys(cityContacts).map((city) => (
                <button
                  key={city}
                  type="button"
                  className={`border px-2 py-1 text-[12px] rounded-lg transition-all ease duration-300 ${
                    selectedCity === city
