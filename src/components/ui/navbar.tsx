          ...
          {path != "/" ? (
              ...
              >
                ...
                <div className="pl-2">
                  ...
                  <p className="m-0 LogoFontText text-xs font-bold text-white">
                    Częstochowie
                  </p>
                </div>
              </Link>
                    ...
                    <div className="group relative px-[6px]">
                      ...
                      <div className="absolute left-0 z-10 hidden w-64 space-y-3 bg-white py-2 shadow-md border group-hover:block shadow-lg rounded-md p-4">
                        {item.node.childItems.edges.map((subItem) => {
                          const isActive =
                            path === new URL(convertToLocalhost(subItem.node.url)).pathname;
                          ...
                          return (
                            <Link
                              ...
                              className={`${
                                isActive ? "text-green-700" : null
                              } block text-black hover:underline `}
                            >
                              {subItem.node.label}
                            </Link>
                          );
