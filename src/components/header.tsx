...
export default function Header() {
  return (
    <header className="bg-[#fafafa] py-0">
      <div className="max-w-[1320px] pt-0 hidden lg:flex mx-auto items-center justify-center">
        <div>
          <div className="grid grid-cols-2 gap-4 items-center">
            <div className="flex items-center justify-center xl:items-start xl:justify-normal">
              <Link href="/">
                <div className="flex items-start leading-9">
                  <svg version="1.1" viewBox="139.31 0 92.39 92.39" xmlns="http://www.w3.org/2000/svg" width="130px" height="130px" style={{ zIndex: 1 }}>
                    <path
                      id="mark"
                      style={{ fill: "#17842f", fillRule: "evenodd" }}
                  ...
                  <div>
                    <div className="pl-[8px] flex flex-col justify-center">
                      <p className="text-[#17822e] font-semibold  LogoFontText  text-[30px]">Polskie</p>
                      <p className="text-[#17822e] LogoFontText font-semibold text-[30px]">Towarzystwo</p>
                      <p className="text-[#17822e] LogoFontText font-semibold  text-[30px]">Ekonomiczne</p>
                    </div>
                    <div className="flex flex-col pl-[8px] justify-center  min-w-[240px]">
                      <p className="text-[#17822e]  LogoFontText font-semibold text-[20px]">Oddział w Częstochowie</p>
                    </div>
                  </div>
                </div>
              </Link>
            </div>
            <div className="ml-24 flex mx-auto">
              <span>
                <Image loading="lazy" src={"/stare_zdjecie_czestochowy.jpg"} width={564} height={200} className="max-w-[400px]" alt="stare_zdjecie_czestochowy " />
              </span>
            </div>
          </div>
        </div>
