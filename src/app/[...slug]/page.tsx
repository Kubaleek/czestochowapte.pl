...
export default function SlugPage() {
  ...
  return (
    <div className="grid grid-cols-12 h-fit gap-[12px] md:gap-[48px]">
      {filteredPages.length > 0 ? <Aside filteredPages={filteredPages} path={path} /> : <div className="col-span-12 md:col-span-4 xl:col-span-3 flex flex-col gap-2 py-[10px] px-[10px]" />}
